...
class Caerleon(NavigationForCity):
    @staticmethod
    def name_of_city():
        return "Caerleon"
    ...
    def _go_to_market_from_travel(self):
        sleep(2)
        self.move_down_left_diagonal(4.5)
        self.move_up_left_diagonal(8.5)
    ...
    def _go_to_travel_from_market_enter(self):
        self.move_down_right_diagonal(7.5)
        self.move_up_right_diagonal(3)

    def _open_an_travel_planer(self):
        self.move_and_click(958, 454)
...
windows = Windows()
def a(hwnd):
    caerleon.go_to_auction_from_travel()
    caerleon.go_to_travel_from_auction()
